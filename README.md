...
- Free Access: All songs are free to play - no subscription or payment required.

## Technologies Used

- Next.js 16: React framework for server-side rendering and building web applications
